...
var Methods = /** @class */ (function () {
    ...
    Methods.prototype.sendRequest = function (action, data, method) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        ...
                        xhr.open(method, "https://cosmoapp.ru/api/v".concat(_this.verAPI, "/").concat(action));
     ...
     */
    Methods.prototype.getMyBalance = function () {
        return __awaiter(this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (result.response.result !== "error") {
                            ...
                            throw new Error("".concat(result.response.desc));
                        }
                        return [2 /*return*/];
                }
            });
     ...
     * @description Получение баланса
     */
    Methods.prototype.getBalance = function (ids) {
        return __awaiter(this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.sendRequest("balance.get", {
                            ids: ids
                        })];
                    case 1:
                        result = (_a.sent());
     ...
     */
    Methods.prototype.getTransfers = function (type, offset, limit) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.sendRequest("transfers.get", {
                            type: type,
                            offset: offset,
                            limit: limit
                        })];
     ...
     */
    Methods.prototype.createTransfer = function (tID, amount) {
        if (tID === void 0) { tID = 0; }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.sendRequest("transfer.create", {
                            to_id: tID,
                            amount: amount
                        })];
                    case 1:
     ...
     */
    Methods.prototype.createCallback = function (url) {
        if (url === void 0) { url = "https://domain.ru"; }
        return __awaiter(this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.sendRequest("callback", {
                            url: url
                        })];
                    case 1:
                        result = _a.sent();
     ...
     */
    Methods.prototype.deleteCallbak = function () {
        return __awaiter(this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.sendRequest("callbak", {}, 'DELETE')];
                    case 1:
                        result = _a.sent();
                        if (result.response.result !== "error") {
                            return [2 /*return*/, result.response.data];
...
var API = /** @class */ (function () {
    ...
    function API(options) {
        this.methods = new Methods(options.key);
    }
    return API;
}());
exports.API = API;
