...
exports.COSMOAPI = void 0;
var XMLHttpRequest = require("xmlhttprequest").XMLHttpRequest;
var COSMOAPI = /** @class */ (function () {
    /**
     * @param {String} option - Обьект данных
     * @param {String} option.key - API-Токен пользователя
     */
    function COSMOAPI(option) {
        /**
         * @param {String} APIKey - API-Токен пользователя
         */
        this.APIKey = option.key;
        this.verAPI = (option === null || option === void 0 ? void 0 : option.v) || "1";
    }
    COSMOAPI.prototype.sendRequest = function (action, data, method) {
     ...
     */
    COSMOAPI.prototype.getMyBalance = function () {
        return __awaiter(this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (result.result !== "error") {
                            ...
                            throw new Error("".concat(result.desc));
                        }
                        return [2 /*return*/];
                }
            });
     ...
     */
    COSMOAPI.prototype.getBalance = function (ids) {
        return __awaiter(this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
     ...
     */
    COSMOAPI.prototype.getTransfers = function (type, offset, limit) {
     ...
     */
    COSMOAPI.prototype.createTransfer = function (tID, amount) {
        if (tID === void 0) { tID = 0; }
